...
Cette évolution ajoute la gestion des commandes de livres, DVD et revues, la gestion des abonnements et l'authentification des utilisateurs via de nouvelles méthodes dans MyAccessBDD.php.

## Fonctionnalités ajoutées

### Méthode selectUtilisateur
Permet de vérifier les identifiants d'un utilisateur (login et mot de passe) et de récupérer ses informations ainsi que son service d'appartenance. Appelée par l'application C# lors de l'authentification au démarrage.

### Méthode selectCommandesDocument
Récupère toutes les commandes d'un document (livre ou DVD) avec le libellé du suivi.

### Méthode deleteCommande
Supprime une commande et son commandedocument associé.

### Méthode selectAbonnements
Récupère tous les abonnements d'une revue.

### Méthode selectRevuesAbonnementsBientotExpires
Récupère les revues dont l'abonnement se termine dans moins de 30 jours.

### Méthode deleteAbonnement
